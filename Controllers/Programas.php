...
<body>
    <div class="sidebar" id="sidebar"> <!-- Barra lateral -->
        ...
        <div class="menu">
            <a href="Dashboard.php">Inicio</a> <!-- Enlace al Dashboard -->
            <a href="usuarios.php">Usuarios</a> <!-- Enlace a Usuarios -->
            <a href="Programas.php">Programas</a> <!-- Enlace a Programas -->
            <a href="donaciones.php">Donaciones</a> <!-- Enlace a Donaciones -->
            <a href="#">Informes</a> <!-- Enlace a Informes -->
